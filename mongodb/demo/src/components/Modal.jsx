...
const Modal = ({ isOpen, isEdit, closeModal, editingId }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    //create a user
    const { name, email, location } = value
    await user.functions.createUser(name,email,location)
      .then(response => {
        setValue({ name: "", email: "", location: "" })
        closeModal()
      }).catch(err => {
